...
import { piezasEscasas as escasas } from "@/lib/escasez";
...
export default async function HomePage() {
   ...
   *
   * El cálculo vive en `lib/escasez.ts` porque no lo usa solo esta página: el
   * menú lo necesita para saber si puede enlazar a `#escasez`. Aquí no cuesta
   * nada, la consulta se comparte con la barra de navegación.
   */
  const piezasEscasas = portada.exclusividad.visible
    ? await escasas(portada.exclusividad.umbral)
    : [];
